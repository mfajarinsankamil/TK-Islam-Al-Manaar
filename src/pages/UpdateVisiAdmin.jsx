...
const UpdateVisiAdmin = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .put("http://localhost:2024/UpdateVisiAdmin/" + id, values)
      .then((res) => navigate("/SekolahAdm", res))
      .catch((err) => console.log(err));
  };
  useEffect(() => {
    axios
      .get("http://localhost:2024/GetRecordVisiAdmin/" + id)
      .then((res) => {
        setValues({
          ...values,
          no: res.data[0].no,
  ...
  return (
    <div>
      ...
      <Box className="updateVisiAdmin-page">
        <Box className="updateVisiAdmin min-vh-99 pt-5">
          <Container>
...
export default UpdateVisiAdmin;
