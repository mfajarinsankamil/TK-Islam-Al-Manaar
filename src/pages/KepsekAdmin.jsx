...
const KepsekAdmin = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:2024/KepsekIdentitas")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:2024/KepsekRipen")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:2024/KepsekRipang")
  ...
  const handleDelete = (id) => {
    axios
      .delete("http://localhost:2024/DeleteKepsekripenAdmin/" + id)
  ...
  const handleDeletee = (id) => {
    axios
      .delete("http://localhost:2024/DeleteKepsekripangAdmin/" + id)
      .then((res) => window.location.reload(res))
      .catch((err) => console.log(err));
  };
