...
const CreateVisiAdmin = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:2024/CreateVisiAdmin", values)
  ...
  return (
    <div>
      ...
      <Box className="createVisiAdmin-page">
        <Box className="createVisiAdmin min-vh-99 pt-5">
          <Container>
...
export default CreateVisiAdmin;
