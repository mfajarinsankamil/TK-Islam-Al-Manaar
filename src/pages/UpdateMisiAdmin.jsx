...
const UpdateMisiAdmin = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .put("http://localhost:2024/UpdateMisiAdmin/" + id, values)
      .then((res) => navigate("/SekolahAdm", res))
      .catch((err) => console.log(err));
  };
  useEffect(() => {
    axios
      .get("http://localhost:2024/GetRecordMisiAdmin/" + id)
      .then((res) => {
        setValues({
          ...values,
          no: res.data[0].no,
  ...
  return (
    <div>
      ...
      <Box className="updateMisiAdmin-page">
        <Box className="updateMisiAdmin min-vh-99 pt-5">
          <Container>
...
export default UpdateMisiAdmin;
